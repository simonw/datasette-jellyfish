...
@pytest.mark.parametrize(
    ...
    (
        ...
        ('jaro_distance("hello", "hello world")', pytest.approx(0.8181818181818182)),
        ('jaro_winkler("hello", "hello world")', pytest.approx(0.890909090909091)),
